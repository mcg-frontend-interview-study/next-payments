...
export default function Complete() {
  ...
  const card_numbers = searchParams.get('card_numbers');
  ...
  return (
    <>
      ...
      <main className="flex flex-col justify-center items-center gap-7 w-full h-screen p-7">
        ...
        <p className="font-bold text-2xl/7 text-center whitespace-pre-line">{`${card_numbers}로 시작하는\n${card_brand}가 등록되었어요.`}</p>
        <Link
          href="/"
